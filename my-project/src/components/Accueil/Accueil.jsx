...
<<<<<<< HEAD
            ...
            et l'hélicopthère expérimental Ingenuity sont arrivés sur Mars, la
            planète rouge le 18 février dernier, le duo travaille sans relache.{" "}
            C'est pourquoi ce Vlog a été créé pour les divertir et vous faire
            profiter de la vue magnifique. Pour vous, ils postent régulièrement
            des nouvelles. <br />
            Votre mission, pour leur plus grand plaisir : leur poster des défis.
=======

            Percy et Ginny ensemble sur Mars ! Le rover Perseverance (dit Percy) de la NASA
            et l'hélicopthère expérimental Ingenuity (dit Ginny) sont arrivés sur Mars, la planète
